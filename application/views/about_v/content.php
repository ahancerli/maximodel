			...
			<div class="col-xl-5">
				<div class="about-two__left">
					<div class="section-title text-left">
						...
						<h2 class="section-title__title">Evlerinizde Fark Yaratıyoruz</h2>
						<div class="section-title__line"></div>
					</div>
					<p class="about-two__text-1">Size daha kaliteli sonuçlar vermek için 30 yılı aşkın deneyime sahibiz.</p>
			...
			<div class="row">
				<div class="col-xl-3">
					<div class="brand-one__title">
						<h2>8800'den Fazla En Popüler Marka Tarafından Güvenilen</h2>
					</div>
				</div>
				<div class="col-xl-9">
