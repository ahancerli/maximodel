		...
		<div class="row">
			<div class="col-xl-5">
				<div class="about-two__left">
					...
					<p class="about-two__text-2">Lorem ipsum dolor sit amet, consectetur notted adipisicing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua lonm andhn.</p>
				...
				<div class="about-two__right">
					<div class="about-two__img-box wow slideInRight" data-wow-delay="100ms"
						...
						<div class="about-two__img-1">
							<img src="<?= base_url("assets") ?>/images/resources/about-two-img-1.jpg" alt="">
						</div>
						<div class="about-two__img-2">
							<img src="<?= base_url("assets") ?>/images/resources/about-two-img-2.jpg" alt="">
						</div>
						<div class="about-two__dot">
							<img src="<?= base_url("assets") ?>/images/shapes/about-two-dots.png" alt="">
						</div>
					</div>
				</div>
			</div>
...
<section class="testimonial-two">
	<div class="testimonial-two-bg" style="background-image: url(<?= base_url("assets") ?>/images/backgrounds/testimonial-two-bg.jpg);"></div>
	<div class="container">
...
<section class="leading">
	<div class="leading-bg-box">
		<div class="leading-bg jarallax" data-jarallax data-speed="0.2" data-imgPosition="50% 0%" style="background-image: url(<?= base_url("assets") ?>/images/backgrounds/leading-bg.jpg);"></div>
	</div>
	<div class="container">
		<div class="row">
			<div class="col-xl-7 col-lg-6">
				<div class="leading__left">
					...
					<h3 class="leading__title">Leadeing in Interior <br> Design Market</h3>
				</div>
			</div>
				...
				<div class="leading__right">
					<ul class="list-unstyled leading__points">
						<li>
							...
							<div class="text">
								<p>We’re expert & certified designers</p>
							</div>
						</li>
						<li>
							<div class="icon">
							...
							<div class="text">
								<p>We use only quality materials</p>
							</div>
						</li>
						<li>
							<div class="icon">
