<head>
	<meta charset="UTF-8" />
	<meta name="description" content=" ماكسيمودل || تصميم">
	<meta name="keywords" content="ماكسي ، نموذج ، تصميم">
	<meta name="author" content="Akman Hançerli">
	<meta name="viewport" content="width=device-width, initial-scale=1.0" />
	<title> ماكسيمودل || تصميم </title>
	<!-- favicons Icons -->
	...
	<link rel="stylesheet" href="<?= base_url("assets") ?>/vendors/ambed-icons/style.css">
	...
	<!-- template styles -->
	<link rel="stylesheet" href="<?= base_url("assets") ?>/css/ambed.css" />
	<link rel="stylesheet" href="<?= base_url("assets") ?>/css/ambed-responsive.css" />

	<!-- modes css -->
	<link rel="stylesheet" id="jssMode" href="<?= base_url("assets") ?>/css/ambed-light.css">


	<!-- toolbar css -->
	<link rel="stylesheet" href="<?= base_url("assets") ?>/vendors/toolbar/css/toolbar.css">
