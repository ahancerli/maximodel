		...
		<div class="swiper-wrapper">
			...
			<div class="swiper-slide">
				<div class="image-layer"
					 style="background-image: url(<?= base_url("assets") ?>/images/backgrounds/main-slider-1-1.jpg);"></div>
				<!-- /.image-layer -->
				<div class="container">
					<div class="row">
						<div class="col-xl-12">
			...
			<div class="swiper-slide">
				<div class="image-layer"
					 style="background-image: url(<?= base_url("assets") ?>/images/backgrounds/main-slider-1-2.jpg);"></div>
				<!-- /.image-layer -->
				<div class="container">
					<div class="row">
						<div class="col-xl-12">
...
<section class="about-one">
	...
	<div class="about-one-wall">
		<img src="<?= base_url("assets") ?>/images/shapes/about-one-wall.png" alt="">
	</div>
	<div class="container">
		<div class="row">
			<div class="col-xl-6">
						...
						<li>
							<div class="about-one__points-content-box">
								...
								<div class="about-one__points-text-box">
									<p class="about-one__points-text">Smart & Unique Wall Work</p>
								</div>
							</div>
						</li>
						<li>
							<div class="about-one__points-content-box">
								...
								<div class="about-one__points-text-box">
									<p class="about-one__points-text">The Best Quality Standards</p>
								</div>
							</div>
						</li>
					</ul>
				...
				<div class="about-one__right">
					<div class="about-one__img-box wow slideInRight" data-wow-delay="100ms"
						...
						<div class="about-one__img">
							<img src="<?= base_url("assets") ?>/images/resources/about-one-img-1.jpg" alt="">
						</div>
						<div class="about-one__small-img">
							<img src="<?= base_url("assets") ?>/images/resources/about-one-small-img.jpg" alt="">
						</div>
						...
						<div class="about-one__dot">
							<img src="<?= base_url("assets") ?>/images/shapes/about-one-dots.png" alt="">
						</div>
					</div>
				</div>
			</div>
			...
			<li class="feature-one__single wow fadeInLeft" data-wow-delay="100ms">
				<div class="feature-one__content">
					<div class="feature-one__shape-1">
						<img src="<?= base_url("assets") ?>/images/shapes/feature-one-shape-1.png" alt="">
					</div>
					<div class="feature-one__shape-2">
						<img src="<?= base_url("assets") ?>/images/shapes/feature-one-shape-2.png" alt="">
					</div>
...
<section class="services-one">
	<div class="services-one-bg-box">
		<div class="services-one-bg jarallax" data-jarallax data-speed="0.2" data-imgPosition="50% 0%"
			 style="background-image: url(<?= base_url("assets") ?>/images/backgrounds/services-one-bg.jpg);"></div>
	</div>
	<div class="container">
		...
		<div class="row">
			<div class="col-xl-4 col-lg-4">
				...
				<div class="services-one__single wow fadeInUp" data-wow-delay="100ms">
					<div class="services-one__img">
						<img src="<?= base_url("assets") ?>/images/services/services-1-1.jpg" alt="">
			...
			<div class="col-xl-4 col-lg-4">
				...
				<div class="services-one__single wow fadeInUp" data-wow-delay="200ms">
					<div class="services-one__img">
						<img src="<?= base_url("assets") ?>/images/services/services-1-2.jpg" alt="">
						<div class="services-one__icon">
			...
			<div class="col-xl-4 col-lg-4">
				...
				<div class="services-one__single wow fadeInUp" data-wow-delay="300ms">
					<div class="services-one__img">
						<img src="<?= base_url("assets") ?>/images/services/services-1-3.jpg" alt="">
						<div class="services-one__icon">
...
<section class="quality-work">
	<div class="quality-work-shape-1 float-bob-x">
		<img src="<?= base_url("assets") ?>/images/shapes/quality-work-shape-1.png" alt="">
	</div>
	<div class="quality-work-shape-2 float-bob-y">
		<img src="<?= base_url("assets") ?>/images/shapes/quality-work-shape-2.png" alt="">
	</div>
	<div class="quality-work-shape-3 float-bob-x">
		<img src="<?= base_url("assets") ?>/images/shapes/quality-work-shape-3.png" alt="">
	</div>
	<div class="quality-work-shape-4">
		<img src="<?= base_url("assets") ?>/images/shapes/quality-work-shape-4.png" alt="">
	</div>
	<div class="quality-work-shape-5 float-bob-x">
		<img src="<?= base_url("assets") ?>/images/shapes/quality-work-shape-5.png" alt="">
	</div>
	<div class="container">
		<div class="row">
			<div class="col-xl-6">
				<div class="quality-work__left">
					<div class="quality-work__img-box">
						<div class="quality-work__img">
							<img src="<?= base_url("assets") ?>/images/resources/quality-work-img-1.png" alt="">
						</div>
						<div class="quality-work__small-img">
							<img src="<?= base_url("assets") ?>/images/resources/quality-work-small-img.jpg" alt="">
						</div>
								...
								<div class="col-xl-6 col-lg-6">
									<div class="project-one__left">
										<div class="project-one__img">
											<img src="<?= base_url("assets") ?>/images/project/project-1-1.jpg" alt="">
										</div>
									</div>
								</div>
								<div class="col-xl-6 col-lg-6">
									<div class="project-one__right">
										<div class="project-one__content-box">
											<div class="project-one-shape-1 float-bob-y">
												<img src="<?= base_url("assets") ?>/images/shapes/project-one-shape-1.png" alt="">
											</div>
											<div class="project-one__content">
												<h4 class="project-one__title">Bedroom Wall Design</h4>
												...
												<a href="project-details.html"
												   class="thm-btn project-one__btn">Read More About</a>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="swiper-slide">
							<div class="row">
								<div class="col-xl-6 col-lg-6">
									<div class="project-one__left">
										<div class="project-one__img">
											<img src="<?= base_url("assets") ?>/images/project/project-1-2.jpg" alt="">
										</div>
									</div>
								</div>
								<div class="col-xl-6 col-lg-6">
						...
						<div class="swiper-slide">
							<div class="row">
								<div class="col-xl-6 col-lg-6">
									<div class="project-one__left">
										<div class="project-one__img">
											<img src="<?= base_url("assets") ?>/images/project/project-1-3.jpg" alt="">
										</div>
									</div>
								</div>
								<div class="col-xl-6 col-lg-6">
						...
						<div class="swiper-slide">
							<div class="row">
								<div class="col-xl-6 col-lg-6">
									<div class="project-one__left">
										<div class="project-one__img">
											<img src="<?= base_url("assets") ?>/images/project/project-1-4.jpg" alt="">
										</div>
									</div>
								</div>
								<div class="col-xl-6 col-lg-6">
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<div class="project-one__img-holder">
								<img src="<?= base_url("assets") ?>/images/project/project-1-thumb-1.jpg" alt="">
							</div>
						</div><!-- /.swiper-slide -->
						<div class="swiper-slide">
							<div class="project-one__img-holder">
								<img src="<?= base_url("assets") ?>/images/project/project-1-thumb-2.jpg" alt="">
							</div>
						</div><!-- /.swiper-slide -->
						<div class="swiper-slide">
							<div class="project-one__img-holder">
								<img src="<?= base_url("assets") ?>/images/project/project-1-thumb-3.jpg" alt="">
							</div>
						</div><!-- /.swiper-slide -->
						<div class="swiper-slide">
							<div class="project-one__img-holder">
								<img src="<?= base_url("assets") ?>/images/project/project-1-thumb-4.jpg" alt="">
							</div>
						</div><!-- /.swiper-slide -->
					</div>
				</div>
			...
			<div class="col-xl-12">
				<div class="project-one__more-project">
					<div class="project-one__more-project-content">
						<p>We’re always ready to serve you. <a href="project-details.html">View more
								projects</a></p>
					</div>
				</div>
			</div>
						...
						<div class="team-one__content">
							<div class="team-one__title-box">
								<div class="team-one__title-shape">
									<img src="<?= base_url("assets") ?>/images/shapes/team-one-title-box-shape.png" alt="">
...
<section class="testimonial-one">
	<div class="testimonial-one-bg-box">
		<div class="testimonial-one-bg jarallax" data-jarallax data-speed="0.2" data-imgPosition="50% 0%"
			 style="background-image: url(<?= base_url("assets") ?>/images/backgrounds/testimonial-one-bg.jpg);"></div>
	</div>
	<div class="container">
		<div class="row">
			<div class="col-xl-3">
				...
				<div class="testimonial-one__right">
					<div class="owl-carousel owl-theme thm-owl__carousel testimonial-one__carousel"
						...
						<div class="testimonial-one__single">
							...
							<div class="testimonial-one__client-info">
								<div class="testimonial-one__img">
									<img src="<?= base_url("assets") ?>/images/testimonial/testimonial-1-1.jpg" alt="">
								</div>
						...
						<div class="testimonial-one__single">
							...
							<div class="testimonial-one__client-info">
								<div class="testimonial-one__img">
									<img src="<?= base_url("assets") ?>/images/testimonial/testimonial-1-2.jpg" alt="">
								</div>
								<div class="testimonial-one__client-content">
						...
						<div class="testimonial-one__single">
							...
							<div class="testimonial-one__client-info">
								<div class="testimonial-one__img">
									<img src="<?= base_url("assets") ?>/images/testimonial/testimonial-1-3.jpg" alt="">
								</div>
								<div class="testimonial-one__client-content">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
				...
				<div class="blog-one__single">
					<div class="blog-one__img">
						<img src="<?= base_url("assets") ?>/images/blog/blog-1-1.jpg" alt="">
			...
			<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
				...
				<div class="blog-one__single">
					<div class="blog-one__img">
						<img src="<?= base_url("assets") ?>/images/blog/blog-1-2.jpg" alt="">
						<a href="blog-details.html">
							<span class="blog-one__plus"></span>
						</a>
					</div>
			...
			<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
				...
				<div class="blog-one__single">
					<div class="blog-one__img">
						<img src="<?= base_url("assets") ?>/images/blog/blog-1-3.jpg" alt="">
						<a href="blog-details.html">
							<span class="blog-one__plus"></span>
						</a>
					</div>
